                                        ...
                                        <div class="container">                                                                                                                                                  
                                            ...
                                            <div class="shipping-info-left-form-delivery-address">
                                                <div class="container">
                                                    ...
                                                    >
                                                    <select class="field-input" id="stored-addresses">
                                                        <option class="field-input-item" value="">
                                                            Choose your address here
                                                            <!-- Ở ĐÂY OPTION MÌNH CÓ THỂ TRUYỀN ĐƯỢC data-properties={"nội dung"} và value ={} -->
                                                        </option>
                                                        <option class="field-input-item" value="${customerInfomation.address}">
