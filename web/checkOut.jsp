            ...
            <header class="header">
                ...
                <div class="nav-bot-responsive">
                    <div class="container">
                        ...
                        <a href="#!" class="menu-responsive-logo">
                            <img srcset="images/LOGO.png 2x" alt="" />
                        </a>
                        <div class="menu-responsive-icon">
                            <img
            ...
            <div class="overview">
                <div class="container">
                    <div class="overview-left">
                        <h1 class="overview-left-title">THANK YOU FOR YOUR ORDER
                            <i class="fa-sharp fa-solid fa-check"></i>
                        </h1>
                        <ul class="overview-left-list">
                            <li class="overview-left-item--circle">
                                <a style="cursor: pointer" href="mainPage" class="overview-left-item-link"
                        ...
                        <div class="overview-right-account-info">
                            ...
                            <ul class="overview-right-account-info-option">
                                <li class="overview-right-account-info-option-item">
                                    <p class="overview-right-account-info-option-item-name">
                                        Name:
                                    </p>
                                    <p
                                        href="#!"
                                        class="overview-right-account-info-option-item-orders"
                                        >
                                        ${customerInfomation.cusName}
                                    </p>
                                </li>
                                <li class="overview-right-account-info-option-item">
                                    <p class="overview-right-account-info-option-item-name">
                                ...
                                <li class="overview-right-account-info-option-item">
                                    <p class="overview-right-account-info-option-item-mail">
                                        Address:
                                    </p>
                                    <p
                                        href="#!"
                                ...
                                <li class="overview-right-account-info-option-item">
                                    ...
                                    <p
                                        href="#!"
                                        class="overview-right-account-info-option-item-acc"
                                        >
                                        COD
                                    </p>
                                </li>
