...
public class PaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String txtOrdersDtID = request.getParameter("txtOrdersDtID");
        int ordersDtID = Integer.parseInt(txtOrdersDtID);
        ...
        try {
            if (paymentID == 1) {
                ...
                boolean result = dao.updatePaymentID(paymentID, ordersDtID);
                if (result) {
                    url = siteMaps.getProperty(
                            MyApplicationConstants.PaymentServlet.MAIN_PAGE);
                }
            } else {
                //Call API PayPal
            }
