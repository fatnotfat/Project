 ...
 */
public class CustomerLoginError implements Serializable{
    private String emailLengthError;
    private String passwordLengthError;
    private String loginFail;

    public CustomerLoginError() {
    }

    public CustomerLoginError(String emailLengthError, String passwordLengthError, String loginFail) {
