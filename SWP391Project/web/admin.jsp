        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="adminPage">
                    ...
                    <div class="sidebar-brand-text mx-3">PDDTK <sup>Dashboard</sup></div>
                </a>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mt-4 text-center small">
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-primary"></i> Nhẫn
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-success"></i> Dây chuyền
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-info"></i> Vòng tay
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-info-2"></i> Khuyên tay
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Doanh thu thực tế theo từng sản phẩm
                                        </h6>
                                    </div>
                                    <!-- TRUYỀN PHẦN TRĂM VÀO ĐÂY -->
                                    <div class="card-body">
                                        <h4 class="small font-weight-bold">Nhẫn <span class="float-right">20%</span></h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-danger" role="progressbar" style="width: 10%"
                                                 aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">Dây chuyền <span class="float-right">40%</span>
                                        </h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                                 aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">Vòng tay <span class="float-right">60%</span>
                                        </h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar" role="progressbar" style="width: 60%"
                                                 aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">Khuyên tai<span class="float-right">80%</span>
                                        </h4>
                                        <div class="progress mb-4">
                                            <div class="progress-bar bg-info" role="progressbar" style="width: 80%"
                                                 aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <h4 class="small font-weight-bold">cái này là gì ta<span
